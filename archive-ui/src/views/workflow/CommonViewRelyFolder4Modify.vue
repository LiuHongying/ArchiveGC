...
import FormFileRelyFolderSelectView from "@/views/workflow/FormFileRelyFolderSelectView.vue";
...
export default {
  ...
  components: {
    ...
    FormFileRelyFolderSelectView:FormFileRelyFolderSelectView
  },
  data() {
    return {
      // 本地存储高度名称
