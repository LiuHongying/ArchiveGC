<template>
  <DataLayout>
    <template v-slot:header>
      ...
      <el-dialog
        :title="$t('message.Batch')+' '+$t('application.Import')+$t('application.document')"
        :visible.sync="batchDialogVisible"
        width="80%"
      >
        <BatchImport
          ref="BatchImport"
          tmpPath="/系统配置/导入模板/文件导入模板"
          :deliveryId="currentFolder.id"
          relationName="FolderId"
          @onImported="onBatchImported"
          width="100%"
          importUrl="/import/batchSystemImport"
        ></BatchImport>
        <div slot="footer" class="dialog-footer">
            ...
            <el-row style="padding-top: 10px; padding-bottom: 10px">
              <el-col style="text-align: left">
                ...
                <el-tooltip
                  ...
                  placement="top"
                >
                  <el-button type="danger" icon="el-icon-delete" circle @click="onDeleleFolder()"></el-button>
                </el-tooltip>
                <el-tooltip
                  class="item"
                  effect="dark"
          ...
          <template slot="paneR">
            <el-row>
              ...
              <el-col :span="3">
                <template v-if="isFileAdmin">
                  ...
                  <el-checkbox v-model="showBox" :disabled="disable" @change="showFileBox">
                    {{
            ...
            <el-row style="margin-top:5px;">
              <el-col :span="3">
                <el-button
                  type="primary"
                  icon="el-icon-files"
                  @click="beforeUploadFile('/dc/addAttachment')"
                >添加附件</el-button>
              </el-col>
              <el-col :span="2">
              ...
              <el-col :span="3">
                <CreateDocNoAttach typeName="图纸文件审批单">新建文件2</CreateDocNoAttach>
              </el-col>
            </el-row>
            <el-row :style="'height:'+layout.height-startHeight+80">
              <DataGrid
                ref="mainDataGrid"
                key="main"
                data-url="/dc/getDocumentsByPermission"
              ...
              >
                <el-dropdown-item slot="dropdownItem"
...
export default {
  ...
  methods: {
    ...
    handleNodeClick(indata) {
      ...
      _self.getPermission(indata.aclName,function(permission){
        if(_self.systemPermission>permission){
          _self.userPermission=systemPermission;
        }else{
          _self.userPermission=permission;
        }
      });
