                ...
                <template slot="paneL">
                    ...
                    @rowclick="onDataGridRowClick"  @selectchange="onSelectChange">
                        ...
                        <template slot="sequee" slot-scope="scope">
                                            ...
                                            &&scope.data.row['STATUS']=='变更中')?{'background':'#409EFF'}:''">{{(scope.currentPage-1) * scope.pageSize+ scope.data.$index+1}}</span>
                        </template>

                         <!-- <template slot="sequee" slot-scope="scope">
                                            <span :style="(scope.data.row['STATUS']!=null
                                            &&scope.data.row['STATUS']=='变更中')?{'background':'#409EFF'}:''">{{(scope.data.currentPage - 1) * scope.data.pageSize+scope.data.$index+1}}</span>
                        </template> -->
