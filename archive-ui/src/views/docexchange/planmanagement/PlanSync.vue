    ...
    <template v-slot:header>
      ...
      <el-dialog title="新建" :visible.sync="dialogCreatevisual">
        <el-form :model="P6form" :inline="true">
          ...
          <el-form-item label="分包商" :label-width="formLabelWidth">
            <DataSelect
              v-model="P6form.C_DESIGN_UNIT"
              queryName="分包商" dataTextField="NAME" dataValueField="NAME"
            ></DataSelect>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    createNewPlan() {
      ...
      m.set("C_DESIGN_UNIT",this.P6form.C_DESIGN_UNIT.replace(/\'/g, ""))
      m.set("TYPE_NAME", "计划");
