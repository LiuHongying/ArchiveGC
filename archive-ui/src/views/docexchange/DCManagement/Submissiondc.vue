<template>
    <DataLayout>
        <template v-slot:header>
            <!-- 待提交文函 -->
            <!-- 材料变更清单Excel导入 -->
            <el-dialog :title="$t('application.Import')" :visible.sync="MeetMaterialDialogVisible" :close-on-click-modal="false" width="80%" >
            ...
            <!-- 设计文件附件 -->
            <el-dialog :title="$t('application.Attachment')" :visible.sync="dialog.visible" width="50%" :close-on-click-modal="false" :before-close="handleClose">      
            ...
            <!-- 创建设计文件附件 -->
            <el-dialog :title="$t('application.Import')" :visible.sync="importSubVisible" width="70%" :close-on-click-modal="false">
                <el-form size="mini" :label-width="formLabelWidth" v-loading='uploading'>
                    <div style="height:200px;overflow-y:scroll; overflow-x:scroll;">
                    <el-upload
                        :limit="100"
            ...
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                ...
                <el-form-item>
                    <UploadZip :selectedItem="selectedItems" @refresh='searchItem' :title="$t('application.UPzip')">{{$t('application.UPzip')}}</UploadZip>
                </el-form-item>
