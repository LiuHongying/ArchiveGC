<template>
    <DataLayout>
        <template v-slot:header>
            <!-- 材料变更清单Excel导入 -->
            <el-dialog :title="$t('application.Import')" :close-on-click-modal="false" :visible.sync="MeetMaterialDialogVisible" width="80%" >
            ...
            <!-- 创建设计文件附件 -->
            <el-dialog :title="$t('application.Import')" :close-on-click-modal="false" :visible.sync="importSubVisible" width="70%">
            ...
            <!-- 相关文件创建选择IED-->
            <el-dialog :title="dialog.title" :close-on-click-modal="false" :visible.sync="propertyrela" width="80%" :before-close="handleClose" > 
                <DataLayout>
                    <template v-slot:header>
                        <el-form>
                        <el-form-item>
            ...
            <!-- 创建分发 -->
        <el-dialog title="分包商选择" :close-on-click-modal="false" :visible.sync="contractorCheckVisible" width="60%" >
        ...
        <!-- 批量导入 -->
        <el-dialog :close-on-click-modal="false" :title="$t('message.Batch')+' '+$t('application.Import')+$t('application.document')" :visible.sync="batchDialogVisible" width="80%" >
        ...
        <!-- 创建附件 -->
        <el-dialog :close-on-click-modal="false" :title="$t('application.Import')" :visible.sync="importdialogVisible" width="70%">
            <el-form size="mini"  v-loading='uploading'>
                <div style="height:200px;overflow-y:scroll; overflow-x:scroll;">
                <el-upload
                    :limit="100"
        ...
        <!-- 创建类型选择 -->
        <el-dialog :close-on-click-modal="false" :visible.sync="childrenTypeSelectVisible">
            <el-form>
