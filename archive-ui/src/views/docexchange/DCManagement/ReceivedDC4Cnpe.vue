    ...
    <DataLayout>
		...
		<el-form :inline="true" :model="filters" @submit.native.prevent>
                ...
                <el-form-item>
                    ...
                    :placeholder="$t('application.PostNumber')+$t('application.or')+$t('application.Title')"  @keyup.enter.native='searchItem'></el-input>
                </el-form-item>
                <el-form-item>
...
export default {
    name: "ReceivedDC4Cnpe",
    data(){
        return{
            // 本地存储高度名称
            topStorageName: 'ReceivedDC4CnpeHeight',
            // 非split pan 控制区域高度
            startHeight: 135,
            // 顶部百分比*100
            topPercent: 65,
    ...
    methods: {
            ...
            _self.validateData(m,function(isOk){
                ...
                .then(function(response) {
                    ...
                    if(code==1){
                        ...
                        _self.$router.push({path:'/cnpe/DCManagement/submissiondc'});
                    }
                    else{
        ...
        searchItem(){
            let _self=this;
            let key=" status='已接收' and TO_NAME='@company'";
