    ...
    <DataLayout>
        <template v-slot:header>
            ...
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                ...
                <el-form-item>
                <el-button  type="primary" @click="pack(selectedItems)">{{$t('application.PackDownload4TRS')}}</el-button>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        let msg = this.$t('message.PleaseSelectDC')
