  ...
  <DataLayout>
    ...
    <template v-slot:main="{layout}">
      <el-row>
        ...
        <el-col :span="3">
          <CreateDocNoAttach :parentId="currentId" :showUpload="false"
           url="/cd/dc/distribute" typeName="分发单">分发</CreateDocNoAttach>
        </el-col>
        <el-col :span="3">
